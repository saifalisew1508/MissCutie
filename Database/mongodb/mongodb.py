...
from MissCutie import DB_NAME, LOGGER, MONGO_DB_URI

try:
    MissCutie_mongodb_client = MongoClient(MONGO_DB_URI)
except PyMongoError as f:
    LOGGER.error(f"Error in Mongodb: {f}")
    exiter(1)
MissCutie_main_db = MissCutie_mongodb_client[DB_NAME]
...
class MongoDB:
    ...
    def __init__(self, collection) -> None:
        self.collection = MissCutie_main_db[collection]
    ...
    @staticmethod
    def close():
        return MissCutie_mongodb_client.close()
