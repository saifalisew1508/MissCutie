        ...
        if len(banned_users[user_id]) >= 5:
            ...
            if time_diff <= 20:
                try:
                    ...
                    message.reply(
                        "I couldn't demote the user because I don't have the necessary permissions."
                    )
                    ...
                    for admin_id in admin_ids:
                        client.send_message(
                            admin_id,
                            "Please keep an eye on the user that just banned 5 users in under 10 seconds, they might be abusing their power.",
                        )
