...
from MissCutie import dispatcher as n
from MissCutie.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler


class MissCutieTelegramHandler:
    def __init__(self, n):
        self._dispatcher = n
...
MissCutiecmd = MissCutieTelegramHandler(n).command
