...
➥ `/importfbans`*:* Import fed bans from a chat""",
        parse_mode=ParseMode.MARKDOWN,
    )
...
__mod_name__ = "Feds"
__help__ = """ Federation everythin is fun, until a spammer start entering your group, and you have to block it. then you need tostart banning more, and more, and its hurt. but then you have many groups, and you don't want this spammer to be in one of your groups - how can you deal? do you have to manually block it, in all your groups? no longer ! with federation, you can make a ban in one chat overlap with all other chats. you can even designate federation admin, so your trusted admin can ban all the spammers from chats you want to protect.


Commands:

feds are now devided in 3 parts for your ease

➥ /fedownerhelp : provide help for creation and owner command

➥ /fedadminhelp : provide help for administration Commands
