...
from MissCutie import BOT_USERNAME
from MissCutie import telethn as borg
...
async def msg(event):
    ...
    caption = f"""<b><u>Information Fetched Successfully </b></u>

<b>Country Name :</b> {name}
<b>Alternative Spelling :</b> {hu}
...
<u>Information By {BOT_USERNAME}</u>
"""
